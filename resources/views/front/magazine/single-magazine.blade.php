...
<section class=" mt-5">
    <nav aria-label="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="btn border-breadcrumb-magazine"><a href="{{ langUrl('/magazine/editorial-board') }}">{{ __('front.editorial_board') }}</a></li>
            <li class="btn border-breadcrumb-magazine"><a href="{{ langUrl('/magazine/contact-us')}}">{{__('front.contact_us')}}</a></li>
        </ul>
      </nav>
</section>
             ...
             <div class="col-lg-8">
                ...
                <ul class="releated">
                    @if (!empty($blog->translation->tags))
                        ...
                        @foreach ($tags as $tag)
                            <li>
                                <a href="{{ langUrl('/magazine/tag/'.$tag) }}">{{$tag}}</a>
                            </li>
                        @endforeach
                    @endif
                </ul>
