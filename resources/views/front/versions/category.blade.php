            ...
            <div class="col-lg-8">
                ...
                <select class="mb-4">
                    ...
                    @foreach ($VersionsCats as $VS)
                        <option @if($VS->id==$category->id) selected @endif value="{{langUrl('/versions/category/'.$VS->slug)}}" data-display="{{$VS->translation->name}}">{{$VS->translation->name}}</option>
                    @endforeach
                  </select>
                </div>
                ...
                <div class="row justify-content-center align-items-center">
                    @foreach ($versions as $key => $row)
                        ...
                        <a href="{{ langUrl('/version/'.$row->slug) }}">
                            ...
                            <strong class="department-name">{{$category->translation->name}}</strong>
                            <hr>
                        <div class="row">
                            <div class="col-6">
                                <div class="text">
