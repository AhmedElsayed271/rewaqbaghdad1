...
@section('title', __('global.MEJEELP_magazine.magazine_edit'))
...
<form action="{{ url()->current() }}" method="post">@csrf
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <label>{{ __('global.MEJEELP_magazine.contact_email') }} <strong class="text-danger">*</strong></label>
            <input type="email" required name="contact_email" value="{{old('contact_email',$row->contact_email)}}" class="form-control" />
        </div>

        <div class="col-md-5 mb-3">
            <label>{{ __('global.MEJEELP_magazine.logo') }} <strong class="text-danger">*</strong></label>
        ...
        <div class="col-md-3 mb-3">
            <label>{{ __('global.MEJEELP_magazine.team.jobs_titles')[appLangKey()]['cbd'] }} <strong class="text-danger">*</strong></label>
        ...
        <div class="col-md-3 mb-3">
            <label>{{ __('global.MEJEELP_magazine.team.jobs_titles')[appLangKey()]['ec'] }} <strong class="text-danger">*</strong></label>
        ...
        <div class="col-md-3 mb-3">
            <label>{{ __('global.MEJEELP_magazine.team.jobs_titles')[appLangKey()]['dec'] }} <strong class="text-danger">*</strong></label>
        ...
        <div class="col-md-3 mb-3">
            <label>{{ __('global.MEJEELP_magazine.team.jobs_titles')[appLangKey()]['me'] }} <strong class="text-danger">*</strong></label>
                            ...
                            <div class="tab-pane {{ ($val->locale==appLangKey())? 'active' : '' }}" id="tab-{{$val->locale}}">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 mb-3">
                                        <label>{{ __('global.MEJEELP_magazine.description') }} ({{ LangNative($val->locale) }}) <strong class="text-danger">*</strong></label>
