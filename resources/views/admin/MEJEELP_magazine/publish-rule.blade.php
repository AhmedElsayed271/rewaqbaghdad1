...
@section('title', __('global.MEJEELP_magazine.publish_rule'))
                            ...
                            <div class="tab-pane {{ ($val->locale==appLangKey())? 'active' : '' }}" id="tab-{{$val->locale}}">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label>{{ __('global.MEJEELP_magazine.publish_rule') }} ({{ LangNative($val->locale) }}) <strong class="text-danger">*</strong></label>
