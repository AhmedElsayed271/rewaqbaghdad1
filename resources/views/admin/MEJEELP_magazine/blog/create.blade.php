...
@section('title', __('global.MEJEELP_magazine.blog.add'))

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ url('/admin/MEJEELP-magazine-blog') }}">{{ __('global.MEJEELP_magazine.blog.title') }}</a></li>
    <li class="breadcrumb-item">@yield('title')</li>
@endsection

@section('content')
<form action="{{ url('/admin/MEJEELP-magazine-blog') }}" method="post">@csrf
    <div class="row">

        <div class="col-md-6 mb-3">
            <label>{{ __('global.MEJEELP_magazine.blog.img') }} <strong class="text-danger">*</strong></label>
        ...
        <div class="col-md-6 mb-3">
            <label>{{ __('global.MEJEELP_magazine.blog.pdf') }} <strong class="text-danger">*</strong></label>
            <div class="input-group">
                <span class="input-group-btn">
        ...
        <div class="col-md-6 mb-3">
            ...
            <div class="input-group mb-3" dir="ltr">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1">{{url('MEJEELP-magazine/blog')}}/</span>
                </div>
        ...
        <div class="col-md-6 mb-3">
            <label>{{ __('global.MEJEELP_magazine.blog.promo_url') }}</label>
            <input dir="ltr" type="url" class="form-control" name="promo_url" value="{{ old("promo_url") }}" />
        </div>
        
        <div class="col-md-3 mb-3">
            <label>{{ __('global.MEJEELP_magazine.blog.number') }} <strong class="text-danger">*</strong></label>
                    ...
                    <div class="tab-content">
                        ...
                        @foreach(SupportedLangs() as $localeCode => $properties)
                            <div class="tab-pane {{ ($localeCode==appLangKey())? 'active' : '' }}" id="tab-{{$localeCode}}">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.MEJEELP_magazine.blog.name') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.MEJEELP_magazine.blog.writer') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.MEJEELP_magazine.blog.description') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.MEJEELP_magazine.blog.tags') }} ({{ $properties['native'] }})</label>
                                        <br />
                                        <input name="tags[{{$localeCode}}]" value="{{ old("tags")[$localeCode] ?? '' }}" class="tag_{{$localeCode}}" placeholder="{{ __('global.version.news_tags') }}" />
                                    </div>

                                    <div class="col-md-12 mb-3">
                                        <label>{{ __('global.MEJEELP_magazine.blog.editorial') }} ({{ LangNative($localeCode) }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    @for ($i = 1; $i < 10; $i++)
                                        <div class="col-md-6 mb-3">
                                            <label>{{ __('global.MEJEELP_magazine.blog.input_title') }} {{$i}} ({{ LangNative($localeCode) }}) </label>
                                            <input dir="{{langDir($localeCode)}}" name="title_{{$i}}[{{$localeCode}}]" value="{{ old("title_".$i)[$localeCode] ?? '' }}" class="form-control" />
                                        </div>
                                        
                                        <div class="col-md-12 mb-3">
                                            <label>{{ __('global.MEJEELP_magazine.blog.input_content') }} {{$i}} ({{ LangNative($localeCode) }}) </label>
