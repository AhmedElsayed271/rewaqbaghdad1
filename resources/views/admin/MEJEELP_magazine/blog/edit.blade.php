...
@section('content')
<form action="{{ url('/admin/MEJEELP-magazine-blog/'.$row->id) }}" method="post">@csrf {{ method_field('PUT') }}
    <div class="row">
                    ...
                    <div class="tab-content">
                        ...
                        @foreach($row->translations as $val)
                            <div class="tab-pane {{ ($val->locale==appLangKey())? 'active' : '' }}" id="tab-{{$val->locale}}">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.MEJEELP_magazine.blog.name') }} ({{ LangNative($val->locale) }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.MEJEELP_magazine.blog.writer') }} ({{ LangNative($val->locale) }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.MEJEELP_magazine.blog.description') }} ({{ LangNative($val->locale) }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.MEJEELP_magazine.blog.tags') }} ({{ LangNative($val->locale) }})</label>
                                        <br />
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label>{{ __('global.MEJEELP_magazine.blog.editorial') }} ({{ LangNative($val->locale) }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    @for ($i = 1; $i < 10; $i++)
                                        ...
                                        @endphp
                                        <div class="col-md-6 mb-3">
                                            <label>{{ __('global.MEJEELP_magazine.blog.input_title') }} {{$i}} ({{ LangNative($val->locale) }}) </label>
                                            <input dir="{{langDir($val->locale)}}" name="title_{{$i}}[{{$val->locale}}]" value="{{ old("title_".$i)[$val->locale] ?? $val->$title }}" class="form-control" />
                                        </div>
                                        
                                        <div class="col-md-12 mb-3">
                                            <label>{{ __('global.MEJEELP_magazine.blog.input_content') }} {{$i}} ({{ LangNative($val->locale) }}) </label>
