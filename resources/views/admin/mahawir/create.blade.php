...
@section('title', __('global.mahwier_add'))
...
@section('content')
<form action="{{ route('mahawirs.store') }}" method="post" enctype="multipart/form-data">@csrf
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <div class="input-group">
                ...
                <input id="thumimg2" required dir="ltr" class="form-control" type="text" name="photo" value="{{ old('thum_img') }}" />
            </div>
                    ...
                    <div class="tab-content">
                        ...
                        @foreach(SupportedLangs() as $localeCode => $properties)
                            <div class="tab-pane {{ ($localeCode==appLangKey())? 'active' : '' }}" id="tab-{{$localeCode}}">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.mahwier_title') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.mahwier_description') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
