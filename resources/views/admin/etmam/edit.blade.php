...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ url('/admin/etmam-news') }}">{{ __('global.etmam_news') }}</a></li>
    <li class="breadcrumb-item">@yield('title')</li>
@endsection

@section('content')
<form action="{{ url('/admin/etmam-news/'.$row->id) }}" method="post">@csrf {{ method_field('PUT') }}
    <div class="row">
