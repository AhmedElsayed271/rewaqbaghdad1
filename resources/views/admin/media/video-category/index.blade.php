            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        var btns = '';
                        @if(auth('admin')->user()->hasPermission('update-categoryLibraryPhoto') || auth('admin')->user()->is_superadmin)
                            btns += edit + ' ' ;
                         @endif
                        @if(auth('admin')->user()->hasPermission('delete-categoryLibraryPhoto') || auth('admin')->user()->is_superadmin)
                            btns += del;
                        @endif
                        return btns;
                    }
