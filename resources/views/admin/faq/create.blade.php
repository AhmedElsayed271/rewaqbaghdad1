                            ...
                            <div class="tab-pane {{ ($localeCode==appLangKey())? 'active' : '' }}" id="tab-{{$localeCode}}">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label>{{ __('global.faq.question') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label>{{ __('global.faq.answer') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
