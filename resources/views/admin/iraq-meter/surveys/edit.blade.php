...
@section('content')
    <form action="{{ route('iraqmeter-surveys.update', $row->id) }}" method="post">@csrf {{ method_field('PUT') }}
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input id="thumimg2" required dir="ltr" class="form-control" type="text" name="pdf"
                        value="{{ old('pdf', $row->pdf) }}" />
                </div>
                                ...
                                <div class="tab-pane {{ $val->locale == appLangKey() ? 'active' : '' }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <label>{{ __('global.magazine.blog.editorial') }}
                                                ({{ LangNative($val->locale) }}) <strong
                                                    class="text-danger">*</strong></label>
