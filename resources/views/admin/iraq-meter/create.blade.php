...
<form action="{{ url('/admin/iraq-meter') }}" method="post">@csrf
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="input-group">
                <span class="input-group-btn">
                    <a id="img2" data-input="promo_url" data-preview="promo_url" class="btn btn-danger text-white">
                        <i class="fa-regular fa-file-pdf"></i> {{ __('global.choose') }}
                    </a>
                </span>
                <input id="promo_url" dir="ltr" required class="form-control text-left" type="text" name="promo_url" value="{{ old('promo_url') }}" />
            </div>
        </div>
