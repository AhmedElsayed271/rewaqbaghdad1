...
@section('title', __('global.activity.news_add'))
...
@section('content')
<form action="{{ url('/admin/activities') }}" method="post">@csrf
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="input-group mb-3" dir="ltr">
                <input type="url" class="form-control" value="{{old('url')}}" name="url" />
            </div>
        </div>
                            ...
                            <div class="tab-pane {{ ($localeCode==appLangKey())? 'active' : '' }}" id="tab-{{$localeCode}}">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.activity.news_name') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.activity.news_tags') }} ({{ $properties['native'] }})</label>
                                        <br />
                                        <input name="tags[{{$localeCode}}]" value="{{ old("tags")[$localeCode] ?? '' }}" class="tag_{{$localeCode}}" placeholder="{{ __('global.activity.news_tags') }}" />
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.activity.news_description') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label>{{ __('global.activity.news_content') }} ({{ LangNative($localeCode) }}) <strong class="text-danger">*</strong></label>
