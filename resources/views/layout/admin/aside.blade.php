...
<aside class="app-sidebar">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu" style="overflow: auto;height: 82vh;">
            ...
            @if ($group->khetab_magazineteam_show=='on'||$group->khetab_magazine_edit=='on'||$group->khetab_magazinerules_edit == 'on'||$group->khetab_magazineblog_show == 'on')
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="#">
                        <i class="fa-solid fa-layer-group"></i>
                        <span class="side-menu__label">{{ __('global.khetab_magazine.title') }}</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        
                        @if ($group->khetab_magazineteam_show == 'on')
                            <li><a class="slide-item" href="{{ url(appLangKey().'/admin/khetab-magazine-team') }}">{{ __('global.khetab_magazine.team.title') }}</a></li>
                        @endif
                        
                        @if ($group->khetab_magazine_edit=='on')
                            <li><a class="slide-item" href="{{ url(appLangKey().'/admin/khetab-magazine') }}">{{ __('global.khetab_magazine.magazine_edit') }}</a></li>
                        @endif
                        
                        @if ($group->khetab_magazinerules_edit == 'on')
                            <li><a class="slide-item" href="{{ url(appLangKey().'/admin/khetab-magazine/publish/rule') }}">{{ __('global.khetab_magazine.publish_rule') }}</a></li>
                        @endif

                        @if ($group->khetab_magazineblog_show == 'on')
                            <li><a class="slide-item" href="{{ url(appLangKey().'/admin/khetab-magazine-blog') }}">{{ __('global.khetab_magazine.blog.title') }}</a></li>
                        @endif
            ...
            @if ($group->khetab_magazineteam_show=='on'||$group->khetab_magazine_edit=='on'||$group->khetab_magazinerules_edit == 'on'||$group->khetab_magazineblog_show == 'on')
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="#">
                        <i class="fa-solid fa-layer-group"></i>
                        <span class="side-menu__label">{{ __('global.MEJEELP_magazine.title') }}</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        
                        @if ($group->khetab_magazineteam_show == 'on')
                            <li><a class="slide-item" href="{{ url(appLangKey().'/admin/MEJEELP-magazine-team') }}">{{ __('global.MEJEELP_magazine.team.title') }}</a></li>
                        @endif
                        
                        @if ($group->khetab_magazine_edit=='on')
                            <li><a class="slide-item" href="{{ url(appLangKey().'/admin/MEJEELP-magazine') }}">{{ __('global.MEJEELP_magazine.magazine_edit') }}</a></li>
                        @endif
                        
                        @if ($group->khetab_magazinerules_edit == 'on')
                            <li><a class="slide-item" href="{{ url(appLangKey().'/admin/MEJEELP-magazine/publish/rule') }}">{{ __('global.MEJEELP_magazine.publish_rule') }}</a></li>
                        @endif

                        @if ($group->khetab_magazineblog_show == 'on')
                            <li><a class="slide-item" href="{{ url(appLangKey().'/admin/MEJEELP-magazine-blog') }}">{{ __('global.MEJEELP_magazine.blog.title') }}</a></li>
                        @endif
