var editor_config = {
  ...
  // document_base_url : window.location.href,
    ...
    file_picker_callback : function(callback, value, meta) {
      ...
      var cmsURL = editor_config.path_absolute + 'filemanager?editor=' + meta.fieldname+'&type=files';
    ...
    init_instance_callback : function(editor) {
      document.querySelector('.tox-notifications-container').style.display = 'none';
    }
};
