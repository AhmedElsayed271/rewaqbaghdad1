...
class MediacenterController extends Controller
{
    ...
    public function news()
    {
        ...
        return view('front.media-center.news', compact('news'));
    }
    ...
    public function Tag($tag)
    {
        ...
        if($check->count() >= 1 ):
            ...
            return view('front.media-center.tag', compact('tag','blogs'));
        endif;
        abort(404);
    }
    ...
    public function SingleNews($slug)
    {
        ...
        if($check->count() == 1):
            ...
            return view('front.media-center.single', compact('blog'));
        endif;
        abort(404);
    }
}
