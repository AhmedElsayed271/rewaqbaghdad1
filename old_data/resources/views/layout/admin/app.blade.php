    ...
    <body class="main-body app sidebar-mini">
                ...
                <div class="container-fluid app-data">
                    ...
                    <nav aria-label="breadcrumb mt-5">
                        <ol class="breadcrumb mb-2" style="background-color:#FFF">
                            <li class="breadcrumb-item"><a href="{{ url('/admin/home') }}">{{ __('global.dashboard') }}</a></li>
                            @yield('breadcrumb')
                        </ol>
                    </nav>
                    <!-- breadcrumb -->
        ...
        <div class="main-footer ht-40">
            <div class="container-fluid pd-t-0-f ht-100p">
                <span>Copyright © {{ date('Y') }}. Designed by <a target="_blank" href="https://www.iraqtechno.com/">iraqtechno</a></span>
            </div>
        </div>
        <!-- Footer closed -->
        ...
        <script>
            ...
            function refreshTime() {
                var dateString = new Date().toLocaleString("en-US", {timeZone: "{{config('app.timezone')}}"});
